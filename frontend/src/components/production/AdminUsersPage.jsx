...
const ROLES = [
  ...
  { value: 'production_manager',   label: 'Responsable Production',      colorPalette: 'blue',   group: 'Production'  },
  ...
  { value: 'storage_manager',      label: 'Responsable Stockage',        colorPalette: 'orange', group: 'Opérations'  },
  { value: 'storage',              label: 'Stockage',                    colorPalette: 'orange', group: 'Opérations'  },
  { value: 'accounting_manager',   label: 'Responsable Comptabilité',    colorPalette: 'green',  group: 'Opérations'  },
  { value: 'accounting',           label: 'Comptabilité',                colorPalette: 'green',  group: 'Opérations'  },
  { value: 'hr_manager',           label: 'Responsable RH',              colorPalette: 'purple', group: 'Opérations'  },
  { value: 'hr',                   label: 'Ressources Humaines',         colorPalette: 'purple', group: 'Opérations'  },
  { value: 'logistics_manager',    label: 'Responsable Logistique',      colorPalette: 'teal',   group: 'Opérations'  },
  { value: 'logistics',            label: 'Logistique',                  colorPalette: 'teal',   group: 'Opérations'  },
  { value: 'installation_manager', label: 'Responsable Installation',    colorPalette: 'indigo', group: 'Opérations'  },
